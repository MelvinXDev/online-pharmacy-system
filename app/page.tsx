...
const DRUGS = [
  { id: 'd1', name: 'Amoxicillin', description: 'Antibiotic used to treat a number of bacterial infections including middle ear infections, strep throat, pneumonia, skin infections, and urinary tract infections.', category: 'Antibiotics', price: 4500, requiresPrescription: true },
  { id: 'd2', name: 'Ibuprofen', description: 'Nonsteroidal anti-inflammatory drug (NSAID) used for treating pain, fever, and inflammation. Common uses include menstrual cramps, migraines, and rheumatoid arthritis.', category: 'Pain Relief', price: 1200, requiresPrescription: false },
  { id: 'd3', name: 'Lisinopril', description: 'Medication of the angiotensin-converting enzyme (ACE) inhibitor class used primarily in treatment of high blood pressure, heart failure, and after heart attacks.', category: 'Cardiovascular', price: 3500, requiresPrescription: true },
  { id: 'd4', name: 'Sertraline', description: 'Antidepressant of the selective serotonin reuptake inhibitor (SSRI) class. Primarily used to treat major depressive disorder and obsessive-compulsive disorder.', category: 'Mental Health', price: 6500, requiresPrescription: true },
  { id: 'd5', name: 'Loratadine', description: 'Antihistamine medication used to treat allergies. This includes allergic rhinitis (hay fever) and hives. Non-drowsy formulation.', category: 'Allergy', price: 2000, requiresPrescription: false },
  { id: 'd6', name: 'Metformin', description: 'First-line medication for the treatment of type 2 diabetes, particularly in people who are overweight. It is also used in the treatment of polycystic ovary syndrome.', category: 'Diabetes', price: 2800, requiresPrescription: true },
  { id: 'd7', name: 'Vitamin C', description: 'Vitamin C supplement for immune support and overall health wellness.', category: 'Vitamins & Supplements', price: 1500, requiresPrescription: false },
  { id: 'd8', name: 'Omeprazole', description: 'Used to treat certain stomach and esophagus problems (such as acid reflux, ulcers).', category: 'Digestive Health', price: 2200, requiresPrescription: false },
  { id: 'd9', name: 'Atorvastatin', description: 'Used together with a proper diet to lower bad cholesterol and fats and raise good cholesterol in the blood.', category: 'Cardiovascular', price: 3000, requiresPrescription: true },
  { id: 'd10', name: 'Albuterol', description: 'Used to prevent and treat wheezing and shortness of breath caused by breathing problems (such as asthma).', category: 'Respiratory', price: 4100, requiresPrescription: true },
  { id: 'd11', name: 'Paracetamol', description: 'Common painkiller used to treat aches and pain. It can also be used to reduce a high temperature.', category: 'Pain Relief', price: 800, requiresPrescription: false },
  { id: 'd12', name: 'Cetirizine', description: 'Antihistamine used to relieve allergy symptoms such as watery eyes, runny nose, itching eyes/nose, sneezing.', category: 'Allergy', price: 1500, requiresPrescription: false },
];
